...
const THAI_COMMENTS = [
  ...
  "ข้อมูลแน่นมากครับ",
  "อธิบายได้ชัดเจนมาก",
  "อยากให้เขียนเรื่องนี้อีก",
  "ยอดเยี่ยมมาก",
  "ชอบสไตล์การเขียนแบบนี้",
  "ติดตามอ่านตลอดเลยครับ",
  "ให้ความรู้ใหม่ๆ เยอะเลย",
  "ขอบคุณที่แบ่งปัน",
  "นำไปปรับใช้ได้จริง",
  "ผู้เขียนเก่งมาก",
  "มีประโยชน์สุดๆ",
  "ชอบตรงที่ยกตัวอย่างชัดเจน",
  "ดีใจที่ได้มาอ่าน",
  "สรุปใจความได้ดีมากครับ"
];
